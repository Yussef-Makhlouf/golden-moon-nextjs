...
export default function AboutUs() {
  return (
    <section className="py-12 sm:py-16 lg:py-24 relative overflow-hidden" id="من نحن">
          ...
          >
            <div>
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 sm:mb-6">
                نحن القمر الذهبي
                <span className="text-primary block mt-3">شريكك في النجاح</span>
              </h1>
            ...
            <div className="grid sm:grid-cols-2 gap-3 sm:gap-4">
              <div className="bg-primary/5 rounded-2xl p-3 sm:p-4">
                <h3 className="text-base sm:text-lg font-bold mb-2">رؤيتنا</h3>
                <p className="text-xs sm:text-sm text-muted-foreground">
                  أن نكون الخيار الأول في حلول الدعاية والإعلان المبتكرة في المملكة
                </p>
              </div>
              <div className="bg-secondary/5 rounded-2xl p-3 sm:p-4">
                <h3 className="text-base sm:text-lg font-bold mb-2">رسالتنا</h3>
                <p className="text-xs sm:text-sm text-muted-foreground">
